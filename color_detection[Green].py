...
# Set the HSV color range for the color you want to detect.
# Example: detecting a green color.
# You will need to adjust these values for your specific object and lighting conditions.
# For example, use an online HSV color picker tool to find the values.
...
while True:
    ...
    largest_contour, center = find_largest_contour(green_mask)
    ...
    if largest_contour is not None and cv2.contourArea(largest_contour) > 500: # Filter out small noise
        ...
        print(f"Green object detected at: ({center[0]}, {center[1]})")
